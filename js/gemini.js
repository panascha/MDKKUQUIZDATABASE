...
3. explain ต้องเขียนเป็น "ภาษาไทยผสมศัพท์ทางการแพทย์ภาษาอังกฤษ" — ห้ามใช้ภาษาอังกฤษอย่างเดียว
   ...
   **ห้ามขึ้นต้น explain ด้วยวลีซ้ำ ๆ เช่น "แนวคิดหลักคือ...", "แนวคิดหลักของ...คือ...",
   ...
   3.1 **กรณีเฉลยถูกมากกว่า 1 ข้อ:** ถ้า answer key ในไฟล์ PDF ทำเครื่องหมายว่าถูกได้มากกว่า 1 ตัวเลือก หรือต้นฉบับระบุว่าเป็นข้อให้คะแนนฟรี/เฉลยถูกหลายข้อ
      ให้ขึ้นต้น explain ด้วยแท็ก **[⚠️ หมายเหตุข้อสอบจริง]:** ชี้แจงสั้นๆ ว่าทำไมตัวเลือกเหล่านั้นถึงถูกได้ทั้งคู่ และทำไมจึงตั้ง answer ที่เลือกเป็นเฉลยหลัก
      (เช่น เป็น First-line treatment / Gold standard ตาม Guideline ปัจจุบัน) แล้วจึงอธิบายกลไกต่อในย่อหน้าเดียวกัน — ต้องขึ้นต้นเป็นแท็กนี้เท่านั้น ไม่ขัดกับกฎห้ามวลีเปิดซ้ำข้างต้น
      ห้ามอนุมานเงื่อนไขนี้เองจากความรู้สึกว่าโจทย์กำกวมถ้า PDF ไม่ได้ระบุ และห้ามใส่ /// ในข้อความหมายเหตุ
