...
- ลำดับการอธิบาย:
  1. เริ่มต้นวิเคราะห์ทันทีด้วยการชี้ diagnostic clues ในโจทย์ที่นำไปสู่คำตอบ "${answer}" ตามด้วย causal chain ของกลไกทางพยาธิสรีรวิทยา (Pathophysiology) หรือโครงสร้างทางกายวิภาคที่เกี่ยวข้องแบบเหตุ-ผลต่อเนื่องกัน (A → B → C) โดยอิงหลักฐานหรือคำแนะนำจากแนวทางการรักษาสากลล่าสุดที่เกี่ยวข้อง
...
- ข้อยกเว้นของกฎห้าม ** และห้ามขึ้นต้นด้วยประโยคสรุป: หากโจทย์หรือเฉลยที่ให้มาระบุชัดว่าข้อนี้มีตัวเลือกที่ถูกต้องได้มากกว่า 1 ข้อ หรือเป็นข้อให้คะแนนฟรี (อาจารย์เฉลยถูกหลายข้อ) ให้ขึ้นต้นย่อหน้าด้วยแท็ก **[⚠️ หมายเหตุข้อสอบจริง]:** (อนุญาตให้ใช้ ** ได้เฉพาะแท็กนี้เท่านั้น) ชี้แจงสั้นๆ ว่าทำไมตัวเลือกเหล่านั้นถึงถูกได้ทั้งคู่ และทำไมระบบจึงตั้ง "${answer}" เป็นเฉลยหลัก (เช่น First-line / Gold standard ตาม Guideline ปัจจุบัน) แล้วจึงอธิบายกลไกต่อในย่อหน้าเดียวกัน — ห้ามอนุมานเงื่อนไขนี้เองถ้าไม่มีหลักฐานชัดเจน ให้เขียนตามปกติ และห้ามใส่ /// ในข้อความหมายเหตุ
